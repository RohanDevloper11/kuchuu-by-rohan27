...
export const SecretDoorAndLetter: React.FC<SecretDoorAndLetterProps> = ({
  ...
  return (
    <div id="secret-door" className="w-full h-full flex flex-col justify-center items-center text-center px-2 sm:px-4 py-1 select-none">
      {!isDoorOpen ? (
        /* The Mysterious Glowing Door */
        <div className="w-full max-w-sm flex flex-col justify-between items-center my-auto py-2 h-[460px] max-h-[calc(100dvh-175px)]">
          {/* Header */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.4 }}
            className="space-y-1 max-w-md mx-auto shrink-0"
          >
          ...
          <div className="my-auto py-1">
            <div className="w-36 h-48 sm:w-44 sm:h-54 rounded-t-full bg-gradient-to-b from-[#2B2338] to-[#171320] border-4 border-[#F7D6C8] shadow-2xl relative flex flex-col items-center justify-center text-white overflow-hidden group mx-auto">
          ...
          <div className="space-y-2 pb-1 shrink-0">
            <button
              id="open-secret-door-btn"
              onClick={handleOpenDoor}
              className="px-6 py-2.5 rounded-full bg-gradient-to-r from-[#D9777F] to-[#C85A66] text-white font-sans font-medium text-xs sm:text-sm hover:opacity-95 active:scale-95 transition-all shadow-md shadow-[#D9777F]/30 flex items-center space-x-1.5 mx-auto cursor-pointer"
            >
        ...
        <div
          ...
          className="w-full max-w-sm h-[470px] max-h-[calc(100dvh-175px)] flex flex-col justify-between items-center rounded-2xl starry-sky p-3 sm:p-4 text-center text-[#FAF7F2] border border-[#E8B4B8]/30 shadow-2xl relative overflow-hidden my-auto"
        >
